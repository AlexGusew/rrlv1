...
//------------------------------------------------------------------------------------
int main() {
  InitWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "rrl - v0.0.3");
  SetTargetFPS(60);
  InitGame();
...
void InitGame() {
  ...
  controlPanel.Initialize(SCREEN_WIDTH, SCREEN_HEIGHT);
...
void DrawGame() {
  ...
  // Draw HUD
  hud.DrawGameHUD(player, controlPanel.IsOpen(), SCREEN_WIDTH, SCREEN_HEIGHT);
}
...
void UpdateDrawFrame() {
  ...
  if (currentGameState == GameState::GAMEPLAY) {
    ...
    hud.DrawMainMenu(SCREEN_WIDTH, SCREEN_HEIGHT);
  } else if (currentGameState == GameState::GAME_OVER) {
    DrawGame();
    hud.DrawGameOver(SCREEN_WIDTH, SCREEN_HEIGHT);
  }
